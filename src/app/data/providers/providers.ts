export const Doctors: ProviderDto[] = [
  {
    id: 'shane',
    name: 'Shane S Pak, MD',
    image: '../../assets/img/doctors/doc-shane.jpg',
    specialization: 'Orthopaedic Spine Surgery',
    about: 'Dr. Pak specializes in Spine Surgery of the neck and back.',
    experience:
      'Dr. Pak is a graduate from the John Hopkins University and received his medical degree from the University of Pennsylvania School of Medicine. He completed his Orthopaedic surgery internship and residency at the Union Memorial Hospital and the Johns Hopkins Medical Institutions in Baltimore, Maryland. <br /> <br /> He completed his Spinal Surgery Fellowship at Rush Presbyterian - St. Luke’s Hospital/Shriner’s Hospital in Chicago with Dr. Ronald DeWald – the oldest spine surgery fellowship program in the United States. <br /> <br /> He practiced spinal surgery in Baltimore from 2001 – 2007 and relocated to California in 2007. Dr. Pak is board certified by the American Board of Orthopaedic Surgery and is an elected Fellow of the American Academy of Orthopaedic Surgeons. <br /> <br /> He is an Active Member of the North American Spine Society and was a guest lecturer at the Johns Hopkins Medical Institutions. <br /> <br />  He is currently the Chairman of Orthopaedic Surgery at San Gabriel Valley Medical Center. In addition, Dr. Pak served as the consulting spine surgeon for the NFL Baltimore Ravens.',
  },

  {
    id: 'david',
    name: 'David W.P. Huang, MD',
    image: '../../assets/img/doctors/doc_david.jpg',
...

  {
    ...
    image: '../../assets/img/doctors/doc_dr-mark-s-hsiao.jpg',
    specialization: 'Orthopaedic Spine Surgery',
    about:
      'Dr. Mark Hsiao is a board-certified orthopaedic surgeon specializing in the surgical and non-surgical treatment of spinal disorders. Dr. Hsiao is committed to providing the most current, successful treatment options that help relieve pain and restore function to his patients.',
    experience:
...
export const Physicians: ProviderDto[] = [
  {
    id: 'benjamin',
    name: 'Benjamin Sham, PA-C',
    image: '../../assets/img/doctors/physist_benjamin-sham.jpg',
    about:
      'Benjamin Sham was born in Monterey Park, California. He grew up in the surrounding area.',
    experience:
